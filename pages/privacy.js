...
export default function PrivacyPage() {
  ...
  return (
    <div style={{ background: "#333699", minHeight: "100vh", position: "relative" }}>
      <Head>
        <title>SoulTrack Privacy Policy</title>
        <meta
          name="description"
          content="Learn how SoulTrack collects, uses and protects your data and your church's data, and what rights you have under GDPR."
        />
        <link rel="canonical" href="https://soultrack.org/privacy" />
      </Head>
