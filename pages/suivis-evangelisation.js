...
export default function SuivisEvangelisation() {
  ...
  const [detailsSuivi, setDetailsSuivi] = useState(null); // objet complet
  ...
  return (
    ...
    >
            ...
            >
              ...
              <div
                className={`transition-all duration-500 overflow-hidden ${
                  detailsSuivi?.id === m.id ? "max-h-[1000px] mt-3" : "max-h-0"
                }`}
              >
                {detailsSuivi?.id === m.id && (
          ...
          <table className="w-full text-sm text-left border-separate border-spacing-0 table-auto">
            <thead className="text-sm uppercase">
              <tr className="bg-gray-200">
                ...
                <th className="px-1 py-1 text-left" style={{ color: "#2E3192" }}>Actions</th>
              </tr>
            </thead>
      ...
      {detailsSuivi && typeof detailsSuivi === "object" && view === "table" && (
