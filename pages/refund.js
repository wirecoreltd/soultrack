...
export default function RefundPage() {
  ...
  return (
    <div style={{ background: "#333699", minHeight: "100vh", position: "relative" }}>
      <Head>
        <title>SoulTrack Refund Policy</title>
        <meta
          name="description"
          content="SoulTrack's refund policy: 14-day free trial, full refund guarantee within 14 days of your first payment, and how to request one."
        />
        <link rel="canonical" href="https://soultrack.org/refund" />
      </Head>
        ...
        {openMenu && (
          <div style={{ background: "#333699", borderTop: "0.5px solid rgba(255,255,255,0.15)", padding: "20px 24px 28px", display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "4px" }}>
              ...
              <button onClick={() => { router.push("/pricing"); setOpenMenu(false); }} style={{ background: "#fff", color: "#333699", border: "none", padding: "11px", borderRadius: "8px", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}>
                {t.signup}
              </button>
            </div>
          </div>
