    ...
    <div className="min-h-screen flex flex-col items-center p-6 bg-[#333699]">
      ...
      <div className="max-w-5xl w-full grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="w-full md:w-96">
          ...
          {/* BOITE EXPLICATION */}
          <div className="bg-blue-900/40 border border-blue-300/30 text-white text-sm p-4 rounded-2xl mb-4">
            ...
            Ces informations sont mises à jour dans la carte <strong>Liste des membres</strong>.
            <div className="mt-2">
              <button
                onClick={() => router.push("/ListeMembres")}
          ...
          {/* MENU SELECTION */}
          <div className="bg-white/10 p-3 rounded-3xl shadow-lg text-white w-full">
