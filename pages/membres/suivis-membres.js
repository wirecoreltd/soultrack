...
const translations = {
  fr: {
    ...
    besoinOptions: {
      ...
      "Couple / Mariage": "Marriage / Relationships",
      "Relations / Conflits": "Relationships / Conflict",
      "Addictions / Dépendances": "Addictions / Dependencies",
      "Vie spirituelle": "Spiritual life",
      "Miracle": "Miracle",
      "Délivrance": "Deliverance",
      "Deuil / Perte": "Grief / Loss",
      "Logement / Sécurité": "Housing / Safety",
      "Immigration / Documents": "Immigration / Documentation",
      "Justice / Protection": "Legal / Protection",
      "Communauté / Isolement": "Community / Isolation",
      "Besoins essentiels": "Basic Needs",
    },
  ...
  en: {
    ...
    besoinOptions: {
      ...
      "Santé mentale / Dépression": "Santé mentale / Dépression",
      "Travail / Études": "Travail / Études",
      "Famille / Enfants": "Famille / Enfants",
      "Couple / Mariage": "Couple / Mariage",
      ...
      "Justice / Protection": "Justice / Protection",
...
function SuivisMembresContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-6" style={{ background: "linear-gradient(to bottom, #3A48A0 0%, #3A48A0 10%, #405BAF 30%, #3E7DCF 55%, #405BAF 80%, #3A48A0 100%)" }}>
      <HeaderPages />
