...
export default function TermsPage() {
  ...
  return (
    <div style={{ background: "#333699", minHeight: "100vh", position: "relative" }}>
      <Head>
        <title>SoulTrack Terms of Service</title>
        <meta
          name="description"
          content="Read SoulTrack's Terms of Service: accounts, acceptable use, subscriptions, data responsibilities and more."
        />
        <link rel="canonical" href="https://soultrack.org/terms" />
      </Head>
        ...
        {openMenu && (
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "4px" }}>
              ...
              <button
                onClick={() => { router.push("/pricing"); setOpenMenu(false); }}
