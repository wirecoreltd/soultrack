      ...
      {/* ================= KPI ================= */}
        {showTable && (
          <div className="w-full max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4 mt-6">
            ...
            {/* Intégrés en cellule */}
            <div
              className="p-4 sm:p-6 rounded-2xl shadow-lg bg-gradient-to-r from-indigo-400 to-indigo-500 text-white flex flex-col items-center"
            ...
            {/* Intégrés à l'église */}
            <div
              className="p-4 sm:p-6 rounded-2xl shadow-lg bg-gradient-to-r from-teal-400 to-teal-500 text-white flex flex-col items-center"
            ...
            {/* Convertis */}
            <div
              className="p-4 sm:p-6 rounded-2xl shadow-lg bg-gradient-to-r from-pink-400 to-pink-500 text-white flex flex-col items-center"
