...
export const tutorialDetails = {
  ...
  "membres/formulaire-nouveau-membre": {
    fr: {
      title: "Envoyer le formulaire d'église — Nouveau membre",
      subtitle: "Sept étapes pour envoyer un lien d'ajout de membre par WhatsApp.",
      steps: [
        {
    ...
    en: {
      title: "Send Church form — New member",
      subtitle: "Seven steps to send a member-registration link via WhatsApp.",
      steps: [
        {
