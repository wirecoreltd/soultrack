...
>
  <div className="w-[160px] text-white font-semibold">
              ...
              monthRapports.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-[180px] text-center text-white -ml-4">
                      {r.nom_formation}
                    </div>                  
                    <div className="w-[100px] text-center text-white -ml-0.5">
                      {r.hommes}
                    </div>                  
  ...
  <div className="w-[160px] text-orange-400 font-semibold ml-7">TOTAL</div>
  <div className="w-[160px]" />
  <div className="w-[180px]" />

  <div className="w-[100px] text-center text-orange-400 font-semibold -ml-5">
    {totalGlobal.hommes}
  </div>
