    ...
    fr: {
      ...
      steps: [
        ...
        },
        {
          title: 'Cliquer sur **"Ajouter"**',
          description:
            "La personne est enregistrée dans les **évangélisés**, et un suivi est automatiquement créé, rattaché à **votre cellule**.",
        },
      ],
    },
    en: {
      ...
      steps: [
        ...
        },
        {
          title: 'Click **"Add"**',
          description:
            "The person is registered under **evangelised contacts**, and a follow-up is automatically created, attached to **your cell group**.",
        },
      ],
    },
  },
