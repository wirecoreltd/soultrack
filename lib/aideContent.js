...
export const categories = {
  fr: [
    { slug: "mise-en-route", emoji: "🚀", title: "Mise en route", description: "Créer votre église, se connecter, télécharger l'app", count: 5 },
    { slug: "membres", emoji: "🧭", title: "Membres", description: "Suivi des membres", count: 8 },
  ...
  en: [
    { slug: "mise-en-route", emoji: "🚀", title: "Getting started", description: "Create your church, log in, download the app", count: 5 },
    { slug: "membres", emoji: "🧭", title: "Members", description: "Member tracking", count: 8 },
...
export const tutorials = {
  membres: {
    fr: {
      subtitle:
        "Accédez facilement à toutes les fonctionnalités de votre équipe : gestion des membres, suivi des familles, création et suivi des conseillers, ainsi que rapports et présences. Tout votre suivi en un seul endroit.",
      items: [
    ...
    en: {
      subtitle:
        "Easily access all the features of your team: member management, family follow-up, counselor creation and tracking, as well as reports and attendance. All your tracking in one place.",
      items: [
