...
function RapportFormation() {
  ...
  // 🔹 Fonctions pour collapse par mois
            ...
            return (
              <div key={monthKey} className="space-y-1">
                ...
                >
                  ...
                  <div className="min-w-[120px] text-center text-orange-400 font-bold">{totalMonth.hommes + totalMonth.femmes}</div>
                </div>
