      ...
      complete: async (results) => {
        ...
        rows.forEach((row, index) => {
          ...
          if (rowErrors.length === 0) {
            validData.push({
              ...
              famille_id: user.famille_id,   // 👈 famille_id au lieu de cellule_id
        ...
        if (phones.length > 0) {
          const { data: existing } = await supabase
            ...
            .eq("famille_id", user.famille_id)   // 👈 famille_id
            .in("telephone", phones);
                ...
                <label className={`flex items-center gap-2 cursor-pointer text-sm px-3 py-1.5 rounded-lg border transition ${
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (e.target.checked) setDepsToAdd((prev) => ({ ...prev, [d.telephone]: false }));
                    }}
                ...
                <label className={`flex items-center gap-2 cursor-pointer text-sm px-3 py-1.5 rounded-lg border transition ${
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (e.target.checked) setDepsToUpdate((prev) => ({ ...prev, [d.telephone]: false }));
                    }}
