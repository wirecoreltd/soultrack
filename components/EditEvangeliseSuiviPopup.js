      ...
      >
        ...
        <div className="flex flex-col gap-4 text-white">
          ...
          {/* Prière du salut */}
            <select
              className="input select-black"
              value={formData.priere_salut === null ? "" : formData.priere_salut ? "Oui" : "Non"}
              required
              onChange={(e) => {
                const value = e.target.value === "Oui" ? true : e.target.value === "Non" ? false : null;
                setFormData({
                  ...formData,
                  priere_salut: value,
                  type_conversion: value ? formData.type_conversion : "", // reset si Non
                });
              }}
            >
