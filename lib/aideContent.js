...
export const categories = {
  fr: [
    ...
    { slug: "evangelisation", emoji: "✝️", title: "Évangélisation", description: "Suivre les nouvelles âmes et leur parcours", count: 3 },
    { slug: "cellules", emoji: "🏠", title: "Cellules", description: "Créer et gérer vos cellules et responsables", count: 8 },
  ...
  en: [
    ...
    { slug: "evangelisation", emoji: "✝️", title: "Evangelism", description: "Follow up new souls and their journey", count: 3 },
    { slug: "cellules", emoji: "🏠", title: "Cell groups", description: "Create and manage cell groups and leaders", count: 8 },
  ...
  cellules: {
    fr: {
      ...
      items: [
        ...
        { slug: "formulaire-evangelisation-cellule", emoji: "🌿", title: "Envoyer formulaire Cellule – Évangélisation" },
    ...
    en: {
      ...
      items: [
        ...
        { slug: "formulaire-evangelisation-cellule", emoji: "🌿", title: "Send Cell form – Evangelism" },
    ...
    fr: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "Tapez un numéro WhatsApp, ou laissez le champ vide pour choisir un contact directement dans **WhatsApp**.",
        },
        {
          title: 'Cliquer sur **"Envoyer"**',
    ...
    en: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: "Type a WhatsApp number, or leave the field blank to pick a contact directly in **WhatsApp**.",
        },
        {
          title: 'Click **"Send"**',
