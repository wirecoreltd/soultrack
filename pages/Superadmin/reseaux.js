...
const STATUTS = [
  ...
  { id: "approved", label: "Approuvé",   emoji: "✔",  color: "rgba(29,158,117,0.85)"  },
  { id: "rejected", label: "Refusé",     emoji: "✖",  color: "rgba(239,68,68,0.85)"   },
];

function ReseauxContent() {
    ...
    <div style={{ background: "#333699", minHeight: "100vh" }}>
      ...
      <div style={{ textAlign: "center", padding: "28px 24px 0" }}>
        <h1 style={{ color: "#fff", fontSize: "clamp(1.4rem,3vw,2rem)", fontWeight: 700, margin: 0 }}>
          Demandes <span style={{ color: "#6ee7b7" }}>Réseaux</span>
        </h1>
        <p style={{ color: "rgba(255,255,255,0.5)", marginTop: "8px", fontSize: "14px" }}>
          Gérez les demandes d'intégration de réseaux d'églises souhaitant rejoindre SoulTrack.
        </p>
      </div>
      ...
      <div style={{ maxWidth: "1000px", margin: "24px auto 0", padding: "0 20px", display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center" }}>
        ...
        <span style={{ color: "rgba(255,255,255,0.4)", fontSize: "13px" }}>{filtered.length} demande{filtered.length !== 1 ? "s" : ""}</span>
      </div>
      ...
      <div style={{ maxWidth: "1000px", margin: "20px auto 60px", padding: "0 20px" }}>
        {loading ? (
          ...
          <p style={{ color: "rgba(255,255,255,0.4)", textAlign: "center", marginTop: "60px" }}>Aucune demande trouvée.</p>
        ) : (
