    ...
    >
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-bold mt-4 mb-6 text-white">
          Gestion des <span className="text-emerald-300">Questions</span>
        </h1>
        <p className="italic text-base text-white/90 max-w-2xl">
          Consultez et répondez aux questions soumises par les utilisateurs via le formulaire de contact.
        </p>
      </div>
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 justify-items-center">
        {loading ? (
          ...
          <p className="text-white col-span-full">Aucune question trouvée.</p>
        ) : (
          filtered.map((t) => (
            <div
              key={t.id}
            ...
            >
              ...
              <div className="p-4 flex flex-col items-center">
                ...
                <div className="text-xs font-semibold mb-2">
                  ...
                  {t.status === "rejected" && (
                    <span className="text-red-600">✖ Ignoré</span>
                  )}
                </div>
