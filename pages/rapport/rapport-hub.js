    ...
    >
      ...
      <div className="text-center mb-6 max-w-3xl">
        ...
        <p className="italic text-base text-white/90">
          {t.intro} <span className="text-blue-300 font-semibold">{t.highlight1}</span> {t.intro2}{" "}
          <span className="text-blue-300 font-semibold">{t.highlight2}</span>{t.intro3}{" "}
          <span className="text-blue-300 font-semibold">{t.highlight3}</span> {t.intro4}{" "}
          <span className="text-blue-300 font-semibold">{t.highlight4}</span> {t.intro5}{" "}
          <span className="text-blue-300 font-semibold">{t.highlight5}</span> {t.intro6}{" "}
          <span className="text-blue-300 font-semibold">{t.highlight6}</span> {t.intro7}
        </p>
      </div>
