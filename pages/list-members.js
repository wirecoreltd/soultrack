                  ...
                  {nouveauxFiltres.map((m, i) => (
                    <tr
                      ...
                      className={`hover:bg-white/10 transition duration-150 ${
                        i !== nouveauxFiltres.length - 1 ? "border-b border-blue-300" : ""
                      }`}
                    >
                      <td
                ...
                <>
                  <tr className="border-b border-blue-300">
                    <td colSpan="4" className="py-3 text-left">
                      <h3 className="text-lg mb-1 font-semibold text-white">
                        Membres existants
                      </h3>
                    </td>
                  </tr>
                  {anciensFiltres.map((m, i) => (
                    <tr
                      key={m.id}
                      className={`hover:bg-white/10 transition duration-150 ${
                        i !== anciensFiltres.length - 1 ? "border-b border-blue-300" : ""
                      }`}
                    >
                      <td
                        className="px-4 py-2 border-l-4 rounded-l-md"
