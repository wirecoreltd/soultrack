  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6 max-w-5xl w-full">
        <h2 className="text-3xl font-extrabold mt-4 mb-6 text-white drop-shadow-lg">Espace Rapports</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="text-4xl mb-2">✅</div>
            <div className="text-lg font-bold text-gray-800 text-center">Registres</div>
          </Link>      
          ...
          >
            <div className="text-4xl mb-2">🌍</div>
            <div className="text-lg font-bold text-gray-800 text-center">Stats Globale</div>
          </Link>    
