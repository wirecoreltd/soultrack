                ...
                return (
                  <div key={group.key}>
                    ...
                    <button
                      ...
                      className="flex items-center px-3 py-1 text-sm bg-white/10 border-l-4 border-orange-500"
                    >
                    ...
                    {isOpen && group.items.map((r) => {
                      ...
                      return (
                        <div
                          ...
                          className="flex items-center px-3 py-1 text-sm bg-white/10 border-l-4 border-blue-500">
