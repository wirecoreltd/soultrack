...
function CellulesHubContent() {
  ...
  // ─── Cartes ResponsableCellule : seulement ces 2 ─────────────────────────
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center w-full max-w-5xl mb-6 flex-wrap">
          ...
          >
            ...
            <div className="text-lg font-bold text-gray-800 text-center">Cellule</div>
          </Link>
  ...
  // ─── Cartes Administrateur / SuperviseurCellule : tout ───────────────────
  return (
    <div
      className="min-h-screen flex flex-col items-center p-6"
      style={{ background: "linear-gradient(135deg, #2E3192 0%, #92EFFD 100%)" }}
