...
export default function ImportMembresFamilleCSV({ user }) {
  ...
  const handleDownloadTemplate = async () => {
    ...
    link.href = url;
    link.download = lang === "en" ? "template_import_family_members.xlsx" : "template_import_membres_famille.xlsx";
    link.click();
  ...
  // ─── Construit la ligne stats_ministere_besoin pour un serviteur ───
