  ...
  return (
    <div key={monthKey} className="space-y-1">
      ...
      >
        ...
        <div className="min-w-[450px] text-center text-white font-bold">{totalMonth.hommes}</div>
        <div className="min-w-[450px] text-center text-white font-bold">{totalMonth.femmes}</div>
        <div className="min-w-[450px] text-center text-orange-500 font-semibold">{totalMonth.total}</div>
