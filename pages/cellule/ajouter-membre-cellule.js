...
const translations = {
  ...
  en: {
    ...
    besoinFinances: "Finances",
    besoinSante: "Physical health",
    besoinDepression: "Mental health / Depression",
    besoinTravail: "Work / Studies",
    besoinFamille: "Family / Children",
    besoinMariage: "Marriage / Relationship",
    besoinRelations: "Relationships / Conflicts",
    besoinAddictions: "Addictions / Dependencies",
    besoinGuidance: "Spiritual life",
    besoinMiracle: "Miracle",
    besoinDelivrance: "Delivrance",
    besoinPerte: "Grief / Loss",
    besoinLogement: "Housing / Safety",
    besoinImmigration: "Immigration / Documents",
    besoinJustice: "Justice / Protection",
    besoinCommunaute: "Community / Isolation",
    besoinEssentiel: "Essential needs",
    besoinAutre: "Other",
...
function AjouterMembreCelluleContent() {
  ...
  const besoinsOptions = [
    ...
    { key: "besoinSante",      value: "Santé physique" },    
