          ...
          {t.features.map((f, i) => (
            ...
            >
              ...
              <div style={{ position: "relative", zIndex: 1 }}>
                <span style={{ fontSize: "24px", display: "block", marginBottom: "16px" }}>
                  {f.icon}
                </span>
                <h3 style={{ color: "#fff", fontSize: "15px", fontWeight: 500, marginBottom: "10px" }}>
                  {f.title}
                </h3>
                <p style={{ color: "rgba(255,255,255)", fontSize: "13.5px", lineHeight: 1.7 }}>
                  {f.desc}
                </p>
              </div>
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ textAlign: "center", marginBottom: "10px" }}>
                        <div style={{ color: "#FFFFFF", fontSize: "14px" }}>{item.church}</div>
                      </div>

                      <div style={{ textAlign: "center" }}>
                        <div style={{ fontSize: "14px" }}>{renderStars(item.note)}</div>
                      </div>
                    </div>
                  </div>
                );
            ...
            {testimonials.map((_, i) => (
              <div
                ...
                style={{
                  ...
                  height: "6px",
                  borderRadius: "3px",
                  background: realIndex === i ? "#fff" : "rgba(255,255,255,0.25)",
