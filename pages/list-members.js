      ...
      {/* ==================== Vue Carte ==================== */}
        {view === "card" && (
          <div className="w-full max-w-5xl space-y-8">
                      ...
                      <div key={m.id} className="bg-white p-3 rounded-xl shadow-md border-l-4 relative" style={{ borderLeftColor: getBorderColor(m) }}>
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <div className="flex flex-col space-y-1 text-sm text-black-600 w-full items-center">
                            ...
                            <div className="flex flex-col space-y-1 text-sm w-full items-center">
                              {m.cellule_nom ? (
                                <div>
            ...
            {/* Anciens Membres : pareil que ci-dessus, appliquer la même logique */}
                    ...
                    return (
                      <div key={m.id} className="bg-white p-3 rounded-xl shadow-md border-l-4 relative" style={{ borderLeftColor: getBorderColor(m) }}>
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          {/* ENVOYER À : identique au bloc ci-dessus */}
                          {/* ... copier le même bloc ENVOYER À ici ... */}
                        </div>
                      </div>
                    );
                  })}
