/* ✅ pages/evangelisation/evangelisation-hub.js */
...
function EvangelisationHubContent() {
  ...
  const isResponsableEvangelisation =
    role === "ResponsableEvangelisation" || role === "Administrateur";
  ...
  // 🔴 Protection (évite crash + build error)
    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        <p className="italic text-base text-white/90">
          Accédez à votre hub d’évangélisation pour consulter la liste des
          évangélisés,{" "}
          <span className="text-blue-300 font-semibold">
            suivre leurs progrès et générer des rapports détaillés avec KPIs et
            statistiques clés
          </span>
          .
        </p>
      ...
      {/* 🔹 Texte */}
      <div className="mt-auto mb-4 text-white italic max-w-2xl">
        Va, fais de toutes les nations des disciples. Chaque rencontre compte,
