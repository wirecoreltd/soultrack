...
export const tutorialDetails = {
  ...
  "membres/supprimer-contact": {
    ...
    fr: {
      ...
      subtitle: "Enregistrez une personne rencontrée en évangélisation via le formulaire WhatsApp.",
      steps: [
        {
          title: 'Cliquer sur **"Envoyer formulaire – Évangélisation"**',
          description:
            "Saisissez un numéro WhatsApp, ou laissez le champ vide pour choisir directement un contact dans **WhatsApp**.",
        },
        {
          title: 'Cliquer sur **"Envoyer"**',
          description:
        ...
        },
        {
          ...
          description:
            "Il renseigne la **date**, le **type d'évangélisation** (Individuel, Sortie de groupe, Campagne, Rue, Maison, Stade), son **identité** (civilité, prénom, nom, âge, téléphone, ville, WhatsApp), la **prière du salut** (Oui/Non + type de conversion si Oui) et ses **besoins**.",
        },
        {
          title: 'Cliquer sur **"Ajouter"**',
          description:
            "Le contact est enregistré et apparaît directement dans la **liste des évangélisés**.",
        },
      ],
    },
    en: {
      title: "Add an evangelised person",
      subtitle: "Record a person met during evangelism via the WhatsApp form.",
      steps: [
        {
          title: 'Click **"Send form – Evangelism"**',
          description:
            "Enter a WhatsApp number, or leave the field blank to pick a contact directly in **WhatsApp**.",
        },
        {
          title: 'Click **"Send"**',
          description:
        ...
        },
        {
          ...
          description:
            "They enter the **date**, the **type of outreach** (Individual, Group outing, Campaign, Street, House, Stadium), their **identity** (title, first/last name, age, phone, city, WhatsApp), the **salvation prayer** (Yes/No + conversion type if Yes) and their **needs**.",
        },
        {
          title: 'Click **"Add"**',
          description:
            "The contact is registered and appears directly in the **evangelised list**.",
        },
      ],
    },
  },
