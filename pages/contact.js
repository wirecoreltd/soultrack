...
export default function ContactPage() {
  ...
  // ── Lire le paramètre ?type= une fois le router prêt ──
  useEffect(() => {
  ...
  const socialLinks = [    
    {
      label: "WhatsApp", href: "https://wa.me/+33757829789",
    ...
    {
      label: "TikTok", href: "https://www.tiktok.com/@soultrack.org",
    ...
    {
      label: "Facebook", href: "https://facebook.com/SoulTrackApp",
