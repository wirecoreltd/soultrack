...
const STATUTS = [
  ...
  { id: "approved", label: "Répondu",    emoji: "✔",  color: "rgba(29,158,117,0.85)"  },
  { id: "rejected", label: "Ignoré",     emoji: "✖",  color: "rgba(239,68,68,0.85)"   },
];
    ...
    <div style={{ background: "#333699", minHeight: "100vh" }}>
      ...
      <div style={{ textAlign: "center", padding: "28px 24px 0" }}>
        <h1 style={{ color: "#fff", fontSize: "clamp(1.4rem,3vw,2rem)", fontWeight: 700, margin: 0 }}>
          Gestion des <span style={{ color: "#6ee7b7" }}>Questions</span>
        </h1>
        <p style={{ color: "rgba(255,255,255,0.5)", marginTop: "8px", fontSize: "14px" }}>
          Consultez et répondez aux questions soumises via le formulaire de contact.
        </p>
      </div>
      ...
      <div style={{ maxWidth: "1000px", margin: "24px auto 0", padding: "0 20px", display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center" }}>
        <div style={{ flex: "1 1 300px", position: "relative" }}>
          ...
          <input type="text" placeholder="Nom · Email · Question…" value={filterText} onChange={e => setFilterText(e.target.value)}
        ...
        <span style={{ color: "rgba(255,255,255,0.4)", fontSize: "13px" }}>{filtered.length} question{filtered.length !== 1 ? "s" : ""}</span>
      </div>
      ...
      <div style={{ maxWidth: "1000px", margin: "20px auto 60px", padding: "0 20px" }}>
        {loading ? (
          ...
          <p style={{ color: "rgba(255,255,255,0.4)", textAlign: "center", marginTop: "60px" }}>Aucune question trouvée.</p>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", gap: "7px" }}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr 2fr 130px 100px", padding: "0 16px 10px", borderBottom: "0.5px solid rgba(255,255,255,0.1)", gap: "8px" }} className="desk-only">
              {["Nom", "Email", "Question", "Statut", ""].map((h, i) => (
