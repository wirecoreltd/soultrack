...
export default function ContactPage() {
  ...
  const handleSubmit = async () => {
    ...
    if (form.type === "temoignage" && (!form.titre || !form.nom_eglise || !form.note)) {
      setError("Veuillez remplir tous les champs du témoignage.");
      return;
    }
    setError("");
    setLoading(true);
  ...
  const socialLinks = [
    {
      label: "Email",
      href: "mailto:support@soultrack.org",
      icon: (
    ...
    {
      label: "TikTok",
      href: "https://tiktok.com/@soultrack",
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      label: "Facebook",
      href: "https://facebook.com/soultrack",
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      label: "LinkedIn",
      href: "https://linkedin.com/company/soultrack",
      icon: (
        <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
  ...
  const successInfo = successMessages[form.type] || successMessages.question;
  ...
  return (
    <div style={{ background: "#333699", minHeight: "100vh", position: "relative" }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "22px 24px", height: "88px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: "10px", alignItems: "center", zIndex: 1, flexShrink: 0 }} className="nav-hide">
            <button onClick={() => router.push("/login")} style={{ background: "transparent", color: "#fbbf24", border: "0.5px solid rgba(255,255,255,0.35)", padding: "7px 18px", borderRadius: "8px", fontSize: "14px", cursor: "pointer" }}>Connexion</button>
            <button onClick={() => router.push("/SignupEglise")} style={{ background: "#fff", color: "#333699", border: "none", padding: "7px 18px", borderRadius: "8px", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}>Créer mon église</button>
          </div>
      ...
      <section style={{ textAlign: "center", padding: "70px 24px 40px", position: "relative", zIndex: 1 }}>
        <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "14px" }}>Contact</p>
        ...
        <p style={{ color: "rgba(255,255,255,0.75)", fontSize: "clamp(0.9rem, 1.8vw, 1rem)", maxWidth: "560px", margin: "0 auto", lineHeight: 1.8 }}>
          Vous avez une question sur SoulTrack, une suggestion pour l'améliorer, ou simplement un témoignage à partager ?
          Chaque message compte. Nous lisons tout avec attention et vous répondons avec soin.
          <br />
          <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.92em" }}>Votre retour nous aide à bâtir un outil toujours plus proche de vos besoins.</span>
        </p>
      </section>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "18px", position: "relative", zIndex: 1 }}>
                ...
                <div>
                  ...
                  <select
                    ...
                    onBlur={e => e.target.style.borderColor = "rgba(255,255,255,0.18)"}
                  >
                    <option value="" disabled style={{ background: "#333699" }}>Sélectionnez un type</option>
                    <option value="amelioration" style={{ background: "#333699", color: "#fff" }}>💡 Amélioration</option>
                    <option value="question" style={{ background: "#333699", color: "#fff" }}>❓ Question</option>
                    <option value="temoignage" style={{ background: "#333699", color: "#fff" }}>✝️ Témoignage</option>
                  </select>
                </div>
                ...
                {form.type === "temoignage" && (
                  <>
                    ...
                    <div>
                      ...
                      <input
                        type="text" placeholder="Ex : Apôtre, Pasteur, Bishop..."
                        value={form.titre}
                    ...
                    {/* Nom église */}
                    <div>
                      <label style={labelStyle}>Nom de l'église</label>
                      <input
                        type="text" placeholder="Ex : Église Grâce et Vérité"
                ...
                <div>
                  ...
                  <textarea
                    placeholder={
                      ...
                      form.type === "temoignage" ? "Partagez ce que Dieu a accompli à travers SoulTrack dans votre église..." :
