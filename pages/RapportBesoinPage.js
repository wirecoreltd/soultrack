    ...
    <div className="min-h-screen flex flex-col items-center p-6 bg-[#333699]">
      ...
      <div className="max-w-3xl w-full mb-6 text-center">
        <p className="italic text-base text-white/90">
          ...
          <span className="text-blue-300 font-semibold">exprimées par les membres</span>, observez les
          tendances et accompagnez chaque personne avec{" "}
          <span className="text-blue-300 font-semibold">
            discernement et un suivi adapté à sa situation
          </span>.
        </p>
      </div>
      ...
      <div className="max-w-3xl w-full mb-6 text-center mt-4">
        <p className="italic text-base text-white/90">
          ...
          Les données sont réparties par catégorie avec la répartition Hommes / Femmes et le
          pourcentage du total des membres.
        </p>
      </div>
          ...
          {labels.map((b, i) => {
            ...
            return (
              <div
                ...
                className={`flex items-center px-3 py-2 rounded-md bg-white/10 hover:bg-white/20 transition border-l-4 ${getBesoinColor(b)}`}
              >
        ...
        {labels.map((b, i) => {
          ...
          return (
            <div
              ...
              onClick={() =>
                router.push(
                  `/list-members?besoin=${b}&dateDebut=${dateDebut}&dateFin=${dateFin}`
                )
              }
