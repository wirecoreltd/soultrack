    ...
    fr: {
      ...
      steps: [
        ...
        },
        {
          title: "Choisir le type de temps",
          description:
            'Sélectionnez un type existant (**École du dimanche**, etc.), ou cliquez sur **"➕ Nouveau type..."** pour en créer un. Cochez **"Enregistrer ce type pour une prochaine fois"** pour le retrouver ensuite.',
        },
        {
          title: 'Cliquer sur **"▶ Démarrer la prise de présence"**',
    ...
    en: {
      ...
      steps: [
        ...
        },
        {
          title: "Choose the session type",
          description:
            'Select an existing type (**Sunday school**, etc.), or click **"➕ New type..."** to create one. Check **"Save this type for next time"** to find it again later.',
        },
        {
          title: 'Click **"▶ Start attendance"**',
